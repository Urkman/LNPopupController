...
- (instancetype)init
{
	...
	if(self)
	{
        ...
        [self addObserver:self forKeyPath:NSStringFromSelector(@selector(imageMargin)) options:0 context:_LNPopupItemObservationContext];
        [self addObserver:self forKeyPath:NSStringFromSelector(@selector(barHeight)) options:0 context:_LNPopupItemObservationContext];
        [self addObserver:self forKeyPath:NSStringFromSelector(@selector(barColor)) options:0 context:_LNPopupItemObservationContext];
        [self addObserver:self forKeyPath:NSStringFromSelector(@selector(hideCloseIcon)) options:0 context:_LNPopupItemObservationContext];
...
- (void)dealloc
{
    ...
    [self removeObserver:self forKeyPath:NSStringFromSelector(@selector(imageMargin)) context:_LNPopupItemObservationContext];
    [self removeObserver:self forKeyPath:NSStringFromSelector(@selector(barHeight)) context:_LNPopupItemObservationContext];
    [self removeObserver:self forKeyPath:NSStringFromSelector(@selector(barColor)) context:_LNPopupItemObservationContext];
    [self removeObserver:self forKeyPath:NSStringFromSelector(@selector(hideCloseIcon)) context:_LNPopupItemObservationContext];
